    ...
    try:
        ...
        if df_processed is not None:
            ...
            if st.button("Yêu cầu AI Phân tích"):
                api_key = "AIzaSyBs0w919rVkaADZVNQSz1ICf_PRVKA6KkE" 
...
# --- HÀM MỚI: Gọi API Gemini cho Trò chuyện (Duy trì Context) ---
def get_ai_response_chat(history, api_key, model_name='gemini-2.5-flash'):
    """Gửi lịch sử trò chuyện đến Gemini API và nhận phản hồi."""
    try:
        client = genai.Client(api_key=api_key)
